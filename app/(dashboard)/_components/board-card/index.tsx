...
export const BoardCard = ({
    ...
    const { mutate: favorite, pending: pendingUnfavorite } = useApiMutations(api.board.favorite);
    const { mutate: onUnfavorite, pending: pendingFavorite } = useApiMutations(api.board.unfavorite);
